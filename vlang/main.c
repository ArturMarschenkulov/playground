...
static int v_typeof_interface_idx_IError(int sidx) { /* IError */ 
	...
	if (sidx == _IError_MessageError_index) return 78;
	return 30;
}
...
u64 math__bits__rem_64(u64 hi, u64 lo, u64 y) {
	multi_return_u64_u64 mr_16704 = math__bits__div_64((u64)(hi % y), lo, y);
	u64 rem = mr_16704.arg1;
	return rem;
}
...
VNORETURN VV_LOCAL_SYMBOL void panic_debug(int line_no, string file, string mod, string fn_name, string s) {
	...
	#else
	{
		...
		eprintln( str_intp(2, _MOV((StrIntpData[]){{_SLIT("   v hash: "), /*115 &string*/0xfe10, {.d_s = _SLIT("cd337e2")}}, {_SLIT0, 0, { .d_c = 0 }}})));
		eprintln(_SLIT("========================================="));
		#if defined(_VNATIVE)
		{
			exit(1);
...
string string_trim(string s, string cutset) {
	...
	multi_return_int_int mr_40722 = string_trim_indexes(s, cutset);
	int left = mr_40722.arg0;
	int right = mr_40722.arg1;
